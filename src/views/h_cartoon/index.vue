    ...
    export default {
        ...
        data() {
            return {
                ...
                showPopup: false,
                showBg: false,
                imgurl: 'https://deeplor.oss-cn-hangzhou.aliyuncs.com/matting2/2020/10/19/https___cdn.pixabay.com_photo_2020_10_17_17_41_girl-5662873_960_720.png',
                imgInfo: 1,
                Original: b_4,//原图链接
        ...
        methods: {
            ...
            afterRead(file) {
                ...
                imgs.onload = () => {
                    EXIF.getData( imgs, function () {
                        ...
                        param.append( 'orientation', _self.imgInfo );
            ...
            loadImg(item) {
                ...
                oImg.src = this.addUrlQuery(item.bgRemovedPreview);
            ...
            initImgData() {
                this.lianImg = JSON.parse( window.localStorage.getItem( 'otherUrl4' ) );
                if( !this.lianImg)return;
                Toast.loading( {mask: true, message: '处理中...', duration: 0} );
                let obj = {url: this.lianImg.url, mattingType: 11};
